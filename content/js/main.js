...
function isValid(url){
    var URL = url;
    var URL2 = URL.split( '/' );
    if( URL2[2] == 'instagram.com' || URL2[2] == 'www.instagram.com' && URL2[3] == 'p' && URL2[4] !== undefined && URL2[4] != ''){
        return true;
    }else{
        return false;
    }
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(mediaType[1] == 'video'){
                        ...
                        var fileNameBig = fileNameBigComplete[fileNameBigComplete.length - 1];
                        
                        var fileNameMediumComplete = mediaUrlMedium.split('/');
                        var fileNameMedium = fileNameMediumComplete[fileNameBigComplete.length - 1]; 
                        ...
                        var mediaUrlMedium = mediaUrlMedium.replace('7.jpg', '6.jpg');
                        
                        var mediaUrlSmall = mediaURLComplete[1].replace('8.jpg', '5.jpg');
                        var mediaUrlSmall = mediaUrlSmall.replace('7.jpg', '5.jpg');
                        ...
                        var fileNameSmall = fileNameSmallComplete[fileNameBigComplete.length - 1].replace('8.jpg', '5.jpg');
                        var fileNameSmall = fileNameSmallComplete[fileNameBigComplete.length - 1].replace('7.jpg', '5.jpg');
                        
                        var fileNameMediumComplete = mediaUrlMedium.split('/');
                        var fileNameMedium = fileNameMediumComplete[fileNameBigComplete.length - 1].replace('8.jpg', '6.jpg');
                        var fileNameMedium = fileNameMediumComplete[fileNameBigComplete.length - 1].replace('7.jpg', '6.jpg');
                    ...
                    var authorComplete = data.match(/<meta property="og:title" content=\"([^\"]*)\" \/>/);
                    
                    $('#media_info').html('<div class="preview"><div class="title"><b>PREVIEW:</b></div><div class="img-video">' + mediaShow + '</div><div class="user_photo">' + authorComplete + '</div><div class="format2">' + mediaFormat + '</div><div class="download_link"></div></div>');
